...
import 'package:hawkshopadmin/screen/add_category.dart';
import 'package:hawkshopadmin/screen/addbrand.dart';
import 'package:hawkshopadmin/widgets/small_card.dart';
        ...
        body: SafeArea(child: Row(
          children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: Wrap(
                      ...
                      children: <Widget>[
                        ...
                        Visibility(visible: appState.selectedScreen == Screen.DASH, child: Wrap(
                          children: <Widget>[
                            SizedBox(
                              width: 10,
                            ),
                  ...
                  InkWell(
                    ...
                    child: Wrap(
                      ...
                      children: <Widget>[
                        ...
                        Visibility(visible: appState.selectedScreen == Screen.PRODUCTS, child: Wrap(
                          children: <Widget>[
                            SizedBox(
                              width: 10,
                            ),
                  ...
                  InkWell(
                    ...
                    child: Wrap(
                      ...
                      children: <Widget>[
                        ...
                        Visibility(visible: appState.selectedScreen == Screen.CATEGORIES, child: Wrap(
                          children: <Widget>[
                            SizedBox(
                              width: 10,
                            ),
                  ...
                  InkWell(
                    ...
                    child: Wrap(
                      ...
                      children: <Widget>[
                        ...
                        Visibility(visible: appState.selectedScreen == Screen.BRANDS, child: Wrap(
                          children: <Widget>[
                            SizedBox(
                              width: 10,
                            ),
                    ...
                    child: InkWell(
                      ...
                      child: Wrap(
                        ...
                        children: <Widget>[
                          ...
                          Visibility(visible: appState.selectedScreen == Screen.ORDERS, child: Wrap(
                            children: <Widget>[
                              SizedBox(
                                width: 10,
                              ),
            ...
            Column(
              ...
              children: <Widget>[
                Padding(padding: const EdgeInsets.only(left: 77.0, top: 5),
                  child: RichText(text: TextSpan(
                    children: [
                      TextSpan(
                        text: 'Revenue:\n', style: TextStyle(fontSize: 30, color: Colors.black),
                      ),
                      TextSpan(text: '\$ XXX.XX', style: TextStyle(fontSize: 35, color: Colors.green, fontWeight: FontWeight.bold)),
                    ])
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Text('Sales per category : ', textAlign: TextAlign.center, style: TextStyle(color: Colors.redAccent),),
                ),
